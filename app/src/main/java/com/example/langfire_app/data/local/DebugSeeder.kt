...
class DebugSeeder @Inject constructor(
    ...
    suspend fun seedIfNeeded() {
        ...
        gamificationSeeder.seedForProfile(activeProfileId)
    ...
    private suspend fun seedProfiles(): List<Int> {
        ...
        val profiles = listOf(
            ProfileEntity(name = "Student", xp = 1350, streakDays = 10, lastActiveDate = now - 2 * DAY_MS, streakFreezes = 1, dailyWordGoal = 25),
            ProfileEntity(name = "Explorer", xp = 420, streakDays = 2, lastActiveDate = now - 2 * DAY_MS, dailyWordGoal = 15),
            ProfileEntity(name = "Achiever", xp = 2200, streakDays = 14, lastActiveDate = now - DAY_MS / 2, dailyWordGoal = 50),
            ProfileEntity(name = "Tester", xp = 120, streakDays = 1, lastActiveDate = now - 3 * DAY_MS, dailyWordGoal = 35)
        )
    ...
    private companion object {
        ...
        const val DEBUG_SEED_VERSION = "5"
